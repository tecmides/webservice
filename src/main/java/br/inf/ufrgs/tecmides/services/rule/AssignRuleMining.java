...
public class AssignRuleMining implements ModuleRuleMining {
    ...
    public List<Rule> getRules( List<RuleModelInstance> instances, RuleService ruleService ) throws Exception {
        ...
        rules.addAll(ruleService.generateRules(new AssignRuleMiningDataset1("assign_rel1", instances), 10, 0.2, 0.7, 1.1, 1.1));
        rules.addAll(ruleService.generateRules(new AssignRuleMiningDataset2("assign_rel2", instances), 10, 0.2, 0.7, 1.1, 1.1));
        rules.addAll(ruleService.generateRules(new AssignRuleMiningDataset3("assign_rel3", instances), 10, 0.2, 0.7, 1.1, 1.1));
